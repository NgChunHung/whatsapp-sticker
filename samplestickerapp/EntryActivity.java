        ...
        protected Pair<String, ArrayList<StickerPack>> doInBackground(Void... voids) {
            ...
            try {
                ...
                if (context != null) {
                    ...
                    Log.d("test6", String.valueOf(stickerPackList));
                    if (stickerPackList.size() == 0) {
                        return new Pair<>("could not find any packs", null);
                    }
                    for (StickerPack stickerPack : stickerPackList) {
                        StickerPackValidator.verifyStickerPackValidity(context, stickerPack);
                        Log.d("test5", String.valueOf(stickerPack));
                    }
                    Log.d("test7", String.valueOf(stickerPackList));
        ...
        protected void onPostExecute(Pair<String, ArrayList<StickerPack>> stringListPair) {
            ...
            if (entryActivity != null) {
                if (stringListPair.first != null) {
                    ...
                    Log.d("test4", String.valueOf(stringListPair.second));
